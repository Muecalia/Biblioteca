        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Loans_AspNetUsers_IdCustomer",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QtdBooks = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LoanBooks_Books_IdBook",
                        column: x => x.IdBook,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LoanBooks_Loans_IdLoan",
                        column: x => x.IdLoan,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoanBooks_IdBook",
                table: "LoanBooks",
                column: "IdBook");

            migrationBuilder.CreateIndex(
                name: "IX_LoanBooks_IdLoan",
                table: "LoanBooks",
                column: "IdLoan");
